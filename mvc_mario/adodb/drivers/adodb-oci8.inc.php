...
class ADODB_oci8 extends ADOConnection {
	...
	var $selectOffsetAlg1 = 10000; // when to use 1st algorithm of selectlimit.
	var $NLS_DATE_FORMAT = 'DD-MM-YYYY';  // To include time, use 'RRRR-MM-DD HH24:MI:SS'
	//var $NLS_DATE_FORMAT = 'YYYY-MM-DD';  // To include time, use 'RRRR-MM-DD HH24:MI:SS'
	//var $NLS_DATE_FORMAT = 'DD-MM-YYYY HH:MI:SS A.M.';  // To include time, use 'RRRR-MM-DD HH24:MI:SS'
