...
class controller_Requisicion extends Requisicion{
	...
	public function set(){
		...
		$objciau = $parametros->crea_objeto("CIAS_X_USUARIO", array("USUARIO"=> "'".$_SESSION['usuario']."'"));
		/*echo"<pre>";
		print_r($objciau);
		echo"</pre>";*/
		$objemp = $parametros->crea_objeto("VWEMPLEADOS", array("COD_EMP"=> $objciau[0]["COD_EMP"]));
        $objdepto = $parametros->crea_objeto("DEPARTAMENTOS", array("COD_DEPTO"=> $objemp[0]["COD_DEPTO"]));
